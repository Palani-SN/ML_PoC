...
CLASS_NAMES = ['BG'] + sorted([file[:-8] for file in os.listdir(f'dot_dataset{os.sep}identicons{os.sep}') if file.endswith('.ome.tif')])
...
print(model.keras_model.summary(line_length = 100))
